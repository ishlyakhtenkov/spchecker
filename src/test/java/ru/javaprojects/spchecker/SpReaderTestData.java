...
public class SpReaderTestData {
    ...
    public static final Path NO_DOCUMENTS_SP_PATH = Path.of("src/test/resources/sp/no_documents_sp.docx");
        ...
        public static List<SpDocument> spDocuments = List.of(
            ...
            new SpDocument("АБВГ.468362.046Э3", "СХЕМА ЭЛЕКТРИЧЕСКАЯ ПРИНЦИПИАЛЬНАЯ"),
            ...
            new SpDocument("АБВГ.468362.046И33", "ИНСТРУКЦИЯ ПО ПРОГРАММИРОВАНИЮ МИКРОСХЕМ"),
            new SpDocument("АБВГ.468362.046Д4", "КОМПЛЕКТ КАРТ ДЛЯ ОЦЕНКИ ПРАВИЛЬНОСТИ ПРИМЕНЕНИЯ ЭРИ"),
