...
import static ru.javaprojects.spchecker.AggregatorTestData.documentsWithNameDifferences;
...
public class AggregatorTest {
    ...
    @Test
    void getDocumentsWithNameDifferences() {
        var aggregator = new Aggregator();
        List<Path> spPaths = List.of(ABVG_301412_847_SP_PATH, ABVG_301412_849_SP_PATH, ABVG_468362_046_SP_PATH);
        aggregator.handleSpecifications(spPaths);
        Assertions.assertEquals(documentsWithNameDifferences, aggregator.getDocumentsWithNameDifferences());
    }
}
